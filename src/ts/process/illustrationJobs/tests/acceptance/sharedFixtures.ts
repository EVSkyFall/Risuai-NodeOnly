...
export const PRODUCTION_PLUGIN = Object.freeze({
    ...
    scriptSha256: '987586f7297b56f767acee718e7f2f6525d86c677b91d64ab14691f9ebe48ba5',
    // 0.2.6 manual capture UX release bundle (279,712 bytes) — digest independently
    // recomputed from the root and dist bundles on 2026-07-20 by scripts/rotate-illustration-pin.mjs.
    scriptSha256Next: 'fb3902e646bd787c6f35f455a9725f044d89d9d0a0dbcafda21c9d2096c6ec6c',
})
